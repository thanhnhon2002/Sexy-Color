...
namespace BBG.PictureColoring
{
    ...
    public class LevelSaveData
    {
        ...
        public bool
            isUnlocked; // This does not need to be included in the save dat since the GameManager handles saving/loading unlocked levels
        ...
        public void FromJson(JSONNode json)
        {
            ...
            isFavourite = json["is_favourite"].AsBool;
        }
