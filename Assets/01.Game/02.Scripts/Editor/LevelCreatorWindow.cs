...
namespace BBG.PictureColoring
{
	public class LevelCreatorWindow : EditorWindow
	{
		...
		private int								lineDarknessThreshold	= 100;
		private int								regionSizeThreshold		= 18;
		private float							colorMergeThreshold		= 0.01f;
		...
		[MenuItem("Tools/ColorPiece/Level Creator", priority = 200)]
